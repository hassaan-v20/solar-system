...
// Smallest positive intercept time for a bolt of speed `bs` against a target at
// relative position `p` closing at relative velocity `vrel`. 0 = no solution.
function interceptTime(p: THREE.Vector3, vrel: THREE.Vector3, bs: number): number {
